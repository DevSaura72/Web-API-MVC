    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UDCMaster", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UDCMaster_AspNetUsers_AddedById",
                        column: x => x.AddedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UDCMaster_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UDCMaster_AspNetUsers_UpdatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UDCMaster_AddedById",
                table: "UDCMaster",
                column: "AddedById");

            migrationBuilder.CreateIndex(
                name: "IX_UDCMaster_DeletedById",
                table: "UDCMaster",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_UDCMaster_UpdatedById",
                table: "UDCMaster",
                column: "UpdatedById");
        }
